...
const CHECKLIST = [
  {
    ...
    desc: "Antes de ingresar credenciales, confirma que el dominio sea exactamente el oficial (ej: corptech.com, sin guiones ni subdominios extraños).",
  },
  {
    icon: "🔒",
    title: "Revisa el certificado HTTPS",
    desc: "Haz clic en el candado del navegador y verifica que el certificado pertenezca al dominio correcto.",
  },
  {
    icon: "🔑",
    title: "Usa un gestor de contraseñas",
    desc: "Los gestores como Bitwarden o 1Password solo autocompletan en el dominio legítimo registrado, bloqueando phishing automáticamente.",
  },
  {
    icon: "📱",
    title: "Activa 2FA / MFA",
    desc: "Incluso si tus credenciales son comprometidas, el segundo factor bloquea el acceso al atacante.",
  },
  {
    icon: "📧",
    title: "Desconfía de correos urgentes",
    desc: 'Los ataques de phishing frecuentemente usan urgencia artificial ("tu cuenta será suspendida") para que actúes sin pensar.',
  },
  {
    icon: "🚫",
    title: "No hagas clic, escribe la URL",
    desc: "Ante cualquier duda sobre un enlace, escribe la dirección directamente en la barra del navegador.",
  },
];
    ...
    <div style={styles.page}>
      ...
      <div style={styles.alertBanner}>
        ...
        <div>
          ...
          <p style={styles.alertSub}>
            Participaste en un ejercicio educativo controlado de{" "}
            <strong>evil twin / phishing</strong>.
            <br />
            <strong>
              Ninguna contraseña fue almacenada ni comprometida.
            </strong>{" "}
            Esto es una prueba pedagógica.
          </p>
        </div>
      </div>
      ...
      <div style={styles.container}>
        ...
        <section style={styles.card}>
          ...
          <p style={styles.text}>
            Visitaste (o enviaste datos en) una página que{" "}
            <strong>imitaba visualmente</strong> el portal corporativo de
            CorpTech S.A. Esta técnica se llama <em>evil twin</em> o{" "}
            <em>phishing por suplantación de identidad</em>: un atacante real
            replaca el diseño de un sitio legítimo en otro dominio para robar
            credenciales.
          </p>
          <p style={styles.text}>
            En este laboratorio controlado, el formulario{" "}
            <strong>nunca envió tus credenciales</strong> a ningún servidor.
            Solo se registró el evento de interacción (si visitaste la página o
            enviaste el formulario) como metadato pedagógico anónimo.
          </p>
          {sessionId !== "N/A" && (
            <div style={styles.sessionBox}>
              <span style={styles.sessionLabel}>
                ID de sesión de referencia:
              </span>
        ...
        <section style={styles.redirectCard}>
          ...
          <div style={styles.redirectActions}>
            ...
            <button
              onClick={() => router.push(LEGITIMATE_URL)}
              style={styles.redirectNow}
            >
              Ir al portal ahora →
            </button>
          </div>
          <p style={styles.redirectNote}>
            Redirigiendo a:{" "}
            <code style={{ fontSize: "12px" }}>{LEGITIMATE_URL}</code>
          </p>
        </section>

        {/* Declaración ficticia */}
        <div style={styles.disclaimer}>
          <strong>DECLARACIÓN:</strong> Este ejercicio es de carácter
          exclusivamente ficticio y pedagógico, realizado en un entorno de
          laboratorio controlado (Lab 8 — Ciberseguridad, Universidad de los
          Andes). No se almacenaron contraseñas, no se involucró personal real,
